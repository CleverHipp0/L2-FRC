...
def get_expense(expense_type, quantity_needed=1):
    ...
    while True:
        ...
        new_expense_name = not_blank("Expense Name: ").lower()
...
print(f"Variable Expenses Sub Total: ${variable_subtotal:.2f}")
...
if fixed_pandas != "":
    ...
    print(fixed_pandas)
    print(f"Fixed Expenses Sub Total: ${fixed_subtotal:.2f}")
